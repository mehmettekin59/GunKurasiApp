...
data class CurrencyResponse(
    ...
    fun toDomain(): Currency {
        try {
            ...
            val canonicalCode = Constants.CurrencyCodes.getCanonicalCode(code)
            ...
            // Değerleri logla
            Log.d("CurrencyResponse", "Dönüştürme: $code → $canonicalCode, Alış: $alis → $buyPrice, Satış: $satis → $sellPrice")

            return Currency(
                code = canonicalCode,
                name = Constants.CurrencyCodes.getDisplayName(canonicalCode),
                buyPrice = buyPrice,
                sellPrice = sellPrice,
            ...
            Log.e("CurrencyResponse", "toDomain hatası: ${e.message}", e)
    ...
    private fun convertToDouble(value: Any?): Double {
        return when (value) {
            ...
            null -> 0.0
                ...
                Log.w("CurrencyResponse", "Bilinmeyen tür dönüşümü: ${value?.javaClass?.name} -> $value")
                0.0
            }
        }
    }
    ...
    private fun parseDate(dateStr: String?): Long {
        ...
        return try {
            ...
            Log.e("CurrencyResponse", "Tarih ayrıştırma hatası: $dateStr, ${e.message}")
